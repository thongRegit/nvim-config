return {
  ...
  config = function()
    ...
    cmp.setup({
      ...
      -- display code suggestion like function, variable
      -- Use ./ to suggestion file to import and display preview
      formatting = {
        fields = { "kind", "abbr", "menu" }, -- Define the order of fields in the menu
